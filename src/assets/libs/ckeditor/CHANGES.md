...
* [#13422](https://dev.ckeditor.com/ticket/13422): Fixed: A revertd font should be used in the `<textarea>` element storing editor configuration in the toolbar configurator.
