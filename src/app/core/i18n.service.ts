...
export class I18nService {
  ...
  constructor(private translateService: TranslateService) {
    ...
    for (let i = 0; i < environment.supportedLanguageObjs.length; i++) {
      translateService.setTranslation(environment.supportedLanguageObjs[i].code,
                                      environment.supportedLanguageObjs[i].source);
    }
  }
